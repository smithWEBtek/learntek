...
Goal.create(name: 'JavaScript', description: 'Read Eloquent, YDKJS, 3 front end apps', status: 'pending')
Goal.create(name: 'CSS grid', description: 'do tutorials, build portfolio samples', status: 'pending')
Goal.create(name: 'postGIS', description: 'do course, build demo app with Boston geodata', status: 'pending')
Goal.create(name: 'SQL', description: 'read and do Kellenberger book', status: 'pending')
Goal.create(name: 'Python', description: 'read book, follow video, build demo app', status: 'pending')
Goal.create(name: 'PHP', description: 'read book, follow video, build demo app', status: 'pending')
Goal.create(name: 'React', description: 'read docs, finish Udemy course', status: 'pending')
Goal.create(name: 'Ember', description: 'read book, follow video, build demo app', status: 'pending')
Goal.create(name: 'Vue', description: 'read book, follow video, build demo app', status: 'pending')
